...
param (
    ...
    [string]$ProjectName = "Northwind.Web",
...
.PARAMETER EnableDocker
    Whether to enable Docker support (default: false)
...
.EXAMPLE
    .\New-DotNetProject.ps1 -ProjectName "MyProject.Api"

.EXAMPLE
    .\New-DotNetProject.ps1 -ProjectName "MyProject.Web" -UseHttps $false -EnableDocker $true

    # Run the script with what-if from the solution root
    pwsh -Command ".\scripts\New-DotNetProject.ps1 -ProjectName 'Test.Project' -WhatIf"
